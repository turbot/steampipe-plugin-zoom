...
func tableZoomUser(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "timezone", Type: proto.ColumnType_STRING, Transform: transform.FromField("PMI"), Description: "The time zone of the user."},
			...
			// TODO - these fields need special request
			...
			{Name: "account_id", Type: proto.ColumnType_STRING, Hydrate: getUser, Description: "User's account ID."},
